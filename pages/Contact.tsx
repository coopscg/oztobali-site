      ...
      <section className="px-6 pb-24">
        <div className="container mx-auto max-w-2xl">
          <div className="bg-white/[0.03] border border-white/5 rounded-[32px] p-8 md:p-10">
            {status === 'succeeded' ? (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-[#F6EFE4]">Check your inbox</h3>
                <p className="text-[#B9CFC9] max-w-sm">
                  We've sent a confirmation to your email with the right guide for your situation. If your question is
                  urgent, just reply directly to that email.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {status === 'error' && (
                  <div className="flex items-center gap-2 text-sm text-[#D9714E] bg-[#D9714E]/10 rounded-xl p-3">
                ...
                >
                  {status === 'submitting' ? 'Sending...' : 'Send Enquiry'} <Send className="w-5 h-5" />
                </button>
              </form>
            )}
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mt-8 text-sm text-[#8FA69E]">
            ...
            Prefer email? <a href="mailto:oztobali1@gmail.com" className="text-[#E3A857] hover:text-[#F6EFE4] transition-colors">oztobali1@gmail.com</a>
          </div>
